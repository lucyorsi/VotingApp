...
function bigint_array_to_hex(array: Array<any>): Array<any> {
...
function bigint_array_to_JSON(array: Array<any>): string {
    return JSON.stringify(bigint_array_to_JSON(array));
}

class FPTPVoter extends CryptoVoter {
